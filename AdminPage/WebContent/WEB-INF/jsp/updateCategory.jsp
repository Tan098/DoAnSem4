					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form:form action="updateCategory" modelAttribute="c"
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label>Bí danh</label>
											<form:input path="alias" type="text" name="alias"
												class="form-control" placeholder="Nhập bí danh" />
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Mô tả</label>
											<form:textarea path="descriptions" type="text"
												name="descriptions" class="form-control"
												placeholder="Nhập mô tả cho danh mục"></form:textarea>
										</div>
									</div>
									<!-- /.card-body -->
